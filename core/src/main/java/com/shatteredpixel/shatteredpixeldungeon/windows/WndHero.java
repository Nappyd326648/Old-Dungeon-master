...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public void initialize(){
			...
			if (intBonus > 0)           statSlot( Messages.get(this, "str"), hero.INT + " + " + intBonus );
			else if (intBonus < 0)      statSlot( Messages.get(this, "str"), hero.INT + " - " + -intBonus );
			else                        statSlot( Messages.get(this, "str"), hero.INT );
