...
public class GamesInProgress {
	...
	public static Info check( int slot ) {
		...
		if (slotStates.containsKey( slot )) {
			...
			try {
				...
				if (info.version < OldDungeon.v1_0_3) {
					info = null;
				}
	...
	public static void set(int slot) {
		...
		info.Int = Dungeon.hero.INT;
		info.intBonus = Dungeon.hero.INT() - Dungeon.hero.INT;
		info.dex = Dungeon.hero.DEX;
		info.dexBonus = Dungeon.hero.DEX() - Dungeon.hero.DEX;
		info.lck = Dungeon.hero.LCK;
		info.exp = Dungeon.hero.exp;
		info.hp = Dungeon.hero.HP;
		info.ht = Dungeon.hero.HT;
		info.mp = Dungeon.hero.MP;
		info.mt = Dungeon.hero.MT;
