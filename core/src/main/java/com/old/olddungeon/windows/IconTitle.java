...
import com.old.olddungeon.ui.HealthBar;
import com.old.olddungeon.ui.ManaBar;
...
public class IconTitle extends Component {
	...
	protected ManaBar mana;

	private float healthLvl = Float.NaN;
	private float manaLvl = Float.NaN;
	...
	protected void layout() {
		...
		mana.visible = !Float.isNaN(manaLvl);
		...
		if (mana.visible) {
			mana.setRect( tfLabel.left(), tfLabel.bottom(), tfLabel.maxWidth(), 0 );
			height = Math.max( imHeight, mana.bottom() );
