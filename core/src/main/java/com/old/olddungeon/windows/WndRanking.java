...
import com.old.olddungeon.ui.BadgesGrid;
import com.old.olddungeon.ui.BadgesList;
import com.old.olddungeon.ui.CheckBox;
import com.old.olddungeon.ui.IconButton;
import com.old.olddungeon.ui.Icons;
import com.old.olddungeon.ui.ItemSlot;
		...
		public StatsTab() {
			...
			IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)){
				...
				protected void onClick() {
					super.onClick();
					OldDungeon.scene().addToFront(new WndScoreBreakdown());
				}
			};
			...
			if (Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						OldDungeon.scene().addToFront(new WndOptions(new Image(icon),
