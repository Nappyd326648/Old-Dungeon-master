...
import com.old.olddungeon.ui.TalentButton;
import com.old.olddungeon.ui.TalentsPane;
...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public void initialize(){
			...
			IconButton infoButton = new IconButton(Icons.get(Icons.INFO)){
				...
				protected void onClick() {
					...
					if (OldDungeon.scene() instanceof GameScene){
						...
						OldDungeon.scene().addToFront(new WndHeroInfo(hero.heroClass));
					}
				}
			...
			int dexBonus = hero.DEX - hero.DEX;
			if (dexBonus > 0)           statSlot( Messages.get(this, "dex"), hero.DEX + " + " + dexBonus );
			else if (dexBonus < 0)      statSlot( Messages.get(this, "dex"), hero.DEX + " - " + -dexBonus );
			else                        statSlot( Messages.get(this, "dex"), hero.DEX );

			int lckBonus = hero.LCK - hero.LCK;
			if (lckBonus > 0)           statSlot( Messages.get(this, "lck"), hero.LCK + " + " + lckBonus );
			else if (lckBonus < 0)      statSlot( Messages.get(this, "lck"), hero.LCK + " - " + -lckBonus );
			else                        statSlot( Messages.get(this, "lck"), hero.LCK );
