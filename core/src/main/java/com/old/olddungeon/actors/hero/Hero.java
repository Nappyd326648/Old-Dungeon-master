...
package com.old.olddungeon.actors.hero;

import com.old.olddungeon.Assets;
import com.old.olddungeon.Badges;
import com.old.olddungeon.Bones;
import com.old.olddungeon.Dungeon;
import com.old.olddungeon.GamesInProgress;
import com.old.olddungeon.SPDSettings;
import com.old.olddungeon.OldDungeon;
import com.old.olddungeon.Statistics;
import com.old.olddungeon.actors.Actor;
import com.old.olddungeon.actors.Char;
import com.old.olddungeon.actors.blobs.SacrificialFire;
import com.old.olddungeon.actors.buffs.AdrenalineSurge;
import com.old.olddungeon.actors.buffs.Amok;
import com.old.olddungeon.actors.buffs.AnkhInvulnerability;
import com.old.olddungeon.actors.buffs.AscensionChallenge;
import com.old.olddungeon.actors.buffs.Awareness;
import com.old.olddungeon.actors.buffs.Barkskin;
import com.old.olddungeon.actors.buffs.Berserk;
import com.old.olddungeon.actors.buffs.Bless;
import com.old.olddungeon.actors.buffs.Buff;
import com.old.olddungeon.actors.buffs.Burning;
import com.old.olddungeon.actors.buffs.Combo;
import com.old.olddungeon.actors.buffs.Drowsy;
import com.old.olddungeon.actors.buffs.Foresight;
import com.old.olddungeon.actors.buffs.HoldFast;
import com.old.olddungeon.actors.buffs.Hunger;
import com.old.olddungeon.actors.buffs.Invisibility;
import com.old.olddungeon.actors.buffs.LostInventory;
import com.old.olddungeon.actors.buffs.MindVision;
import com.old.olddungeon.actors.buffs.Momentum;
import com.old.olddungeon.actors.buffs.Paralysis;
import com.old.olddungeon.actors.buffs.Regeneration;
import com.old.olddungeon.actors.buffs.SnipersMark;
import com.old.olddungeon.actors.buffs.Vertigo;
import com.old.olddungeon.actors.hero.abilities.ArmorAbility;
import com.old.olddungeon.actors.hero.abilities.huntress.NaturesPower;
import com.old.olddungeon.actors.hero.abilities.warrior.Endure;
import com.old.olddungeon.actors.mobs.Mob;
import com.old.olddungeon.actors.mobs.Monk;
import com.old.olddungeon.actors.mobs.Snake;
import com.old.olddungeon.effects.CellEmitter;
import com.old.olddungeon.effects.CheckedCell;
import com.old.olddungeon.effects.Speck;
import com.old.olddungeon.effects.SpellSprite;
import com.old.olddungeon.items.Amulet;
import com.old.olddungeon.items.Ankh;
import com.old.olddungeon.items.Dewdrop;
import com.old.olddungeon.items.EquipableItem;
import com.old.olddungeon.items.Heap;
import com.old.olddungeon.items.Heap.Type;
import com.old.olddungeon.items.Item;
import com.old.olddungeon.items.KindOfWeapon;
import com.old.olddungeon.items.armor.Armor;
import com.old.olddungeon.items.armor.ClassArmor;
import com.old.olddungeon.items.armor.glyphs.AntiMagic;
import com.old.olddungeon.items.armor.glyphs.Brimstone;
import com.old.olddungeon.items.armor.glyphs.Viscosity;
import com.old.olddungeon.items.artifacts.AlchemistsToolkit;
import com.old.olddungeon.items.artifacts.CapeOfThorns;
...
import com.old.olddungeon.items.bags.MagicalHolster;
import com.old.olddungeon.items.journal.Guidebook;
import com.old.olddungeon.items.keys.CrystalKey;
import com.old.olddungeon.items.keys.GoldenKey;
import com.old.olddungeon.items.keys.IronKey;
import com.old.olddungeon.items.keys.Key;
import com.old.olddungeon.items.keys.SkeletonKey;
...
import com.old.olddungeon.items.potions.elixirs.ElixirOfMight;
import com.old.olddungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.old.olddungeon.items.scrolls.exotic.ScrollOfChallenge;
import com.old.olddungeon.items.wands.Wand;
import com.old.olddungeon.items.wands.WandOfLivingEarth;
import com.old.olddungeon.items.weapon.SpiritBow;
...
import com.old.olddungeon.journal.Document;
import com.old.olddungeon.journal.Notes;
import com.old.olddungeon.levels.Level;
import com.old.olddungeon.levels.Terrain;
import com.old.olddungeon.levels.features.Chasm;
import com.old.olddungeon.levels.features.LevelTransition;
import com.old.olddungeon.levels.traps.Trap;
import com.old.olddungeon.mechanics.ShadowCaster;
import com.old.olddungeon.messages.Messages;
import com.old.olddungeon.plants.Swiftthistle;
import com.old.olddungeon.scenes.AlchemyScene;
import com.old.olddungeon.scenes.GameScene;
import com.old.olddungeon.scenes.InterlevelScene;
import com.old.olddungeon.scenes.SurfaceScene;
import com.old.olddungeon.sprites.CharSprite;
import com.old.olddungeon.sprites.HeroSprite;
import com.old.olddungeon.sprites.ItemSprite;
import com.old.olddungeon.sprites.ItemSpriteSheet;
import com.old.olddungeon.ui.AttackIndicator;
import com.old.olddungeon.ui.BuffIndicator;
import com.old.olddungeon.ui.QuickSlotButton;
import com.old.olddungeon.ui.StatusPane;
import com.old.olddungeon.utils.GLog;
import com.old.olddungeon.windows.WndHero;
import com.old.olddungeon.windows.WndMessage;
import com.old.olddungeon.windows.WndOptions;
import com.old.olddungeon.windows.WndResurrect;
import com.old.olddungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public static final int STARTING_LCK = 10;
	...
	public void updateMT( boolean boostMP ){
		int curMT = MT;

		MT = 20 + 5*(lvl-1) + MTBoost;
		float multiplier = RingOfMight.HTMultiplier(this);
		MT = Math.round(multiplier * MT);


		if (boostMP){
			MP += Math.max(MT - curMT, 0);
		}
		MP = Math.min(MP, MT);
	}
	...
	public int INT() {
		...
		intBonus += RingOfMight.strengthBonus( this );
		...
		if (hasTalent(Talent.STRONGMAN)){
			intBonus += (int)Math.floor(INT * (0.03f + 0.05f*pointsInTalent(Talent.STRONGMAN)));
		}
	...
	public int DEX() {
		...
		dexBonus  += RingOfMight.strengthBonus( this );
		...
		if (hasTalent(Talent.STRONGMAN)){
			dexBonus  += (int)Math.floor(DEX * (0.03f + 0.05f*pointsInTalent(Talent.STRONGMAN)));
		}
	...
	public int LCK() {
		...
		lckBonus  += RingOfMight.strengthBonus( this );
	...
	private static final String LUCK	= "LCK";
	private static final String LEVEL		= "lvl";
	private static final String EXPERIENCE	= "exp";
	private static final String HTBOOST     = "htboost";
	private static final String MTBOOST     = "mtboost";
	...
	public int damageRoll() {
		//todo add primeary stat to damage
		KindOfWeapon wep = belongings.weapon();
		int dmg;
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			OldDungeon.switchScene(AlchemyScene.class);
			return false;
		...
		if (rooted) {
			...
			if (transition.type == LevelTransition.Type.SURFACE){
				if (belongings.getItem( Amulet.class ) == null) {
					...
					&& Dungeon.initialVersion > OldDungeon.v1_2_3
