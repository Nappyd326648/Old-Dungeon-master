...
package com.old.olddungeon.journal;
...
public enum Document {
	...
	static {
		...
		ADVENTURERS_GUIDE.pagesStates.put("Intelligence",           debug ? READ : NOT_FOUND);
		ADVENTURERS_GUIDE.pagesStates.put("Dexterity",           debug ? READ : NOT_FOUND);
		ADVENTURERS_GUIDE.pagesStates.put("Luck",           debug ? READ : NOT_FOUND);
