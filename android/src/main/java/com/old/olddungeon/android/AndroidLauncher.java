...
package com.old.olddungeon.android;
...
import com.old.olddungeon.services.news.NewsImpl;
import com.old.olddungeon.services.updates.UpdateImpl;
...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		initialize(new OldDungeon(support), config);
